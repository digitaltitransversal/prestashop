 ...
 */
class CreateCustomerFiscalEntitiesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_customer_fiscal_entities_response';
