 ...
 */
class OrderResponseCheckout implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'order_response_checkout';
    ...
    */
    ...
    /**
     * Gets is_redirect_on_failure
     *
     * @return bool|null
     */
    public function getIsRedirectOnFailure()
    {
        return $this->container['is_redirect_on_failure'];
    }

    /**
     * Sets is_redirect_on_failure
     *
     * @param bool|null $is_redirect_on_failure is_redirect_on_failure
     *
     * @return self
     */
    public function setIsRedirectOnFailure($is_redirect_on_failure)
    {
        if (is_null($is_redirect_on_failure)) {
            throw new \InvalidArgumentException('non-nullable is_redirect_on_failure cannot be null');
        }
        $this->container['is_redirect_on_failure'] = $is_redirect_on_failure;
    ...
    public function setMetadata($metadata)
    {
        ...
        if ((count($metadata) > 100)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling OrderResponseCheckout., number of items must be less than or equal to 100.');
        }
