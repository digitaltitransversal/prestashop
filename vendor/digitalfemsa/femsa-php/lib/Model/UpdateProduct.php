...
class UpdateProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setUnitPrice($unit_price)
    {
        ...
        if (($unit_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_price when calling UpdateProduct., must be bigger than or equal to 0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling UpdateProduct., must be bigger than or equal to 1.');
        }
