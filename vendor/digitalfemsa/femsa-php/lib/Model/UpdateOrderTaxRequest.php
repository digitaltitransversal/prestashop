 ...
 */
class UpdateOrderTaxRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_order_tax_request';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling UpdateOrderTaxRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) < 2)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateOrderTaxRequest., must be bigger than or equal to 2.');
        }
    ...
    public function setMetadata($metadata)
    {
        ...
        if ((count($metadata) > 100)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling UpdateOrderTaxRequest., number of items must be less than or equal to 100.');
        }
