...
class TransfersApi
{
    ...
    {
        list($response) = $this->getTransferWithHttpInfo($id, $accept_language, $x_child_company_id, $contentType);
        return $response;
    }
     ...
     */
    public function getTransferAsync($id, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['getTransfer'][0])
    {
        return $this->getTransferAsyncWithHttpInfo($id, $accept_language, $x_child_company_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function getTransferRequest($id, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['getTransfer'][0])
    {
    ...
    {
        list($response) = $this->getTransfersWithHttpInfo($accept_language, $x_child_company_id, $limit, $search, $next, $previous, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTransfersAsync($accept_language = 'es', $x_child_company_id = null, $limit = 20, $search = null, $next = null, $previous = null, string $contentType = self::contentTypes['getTransfers'][0])
    {
        return $this->getTransfersAsyncWithHttpInfo($accept_language, $x_child_company_id, $limit, $search, $next, $previous, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTransfersRequest($accept_language = 'es', $x_child_company_id = null, $limit = 20, $search = null, $next = null, $previous = null, string $contentType = self::contentTypes['getTransfers'][0])
    {



        if ($limit !== null && $limit > 250) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling TransfersApi.getTransfers, must be smaller than or equal to 250.');
        }
