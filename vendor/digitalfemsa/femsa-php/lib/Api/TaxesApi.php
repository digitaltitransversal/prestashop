...
class TaxesApi
{
    ...
    public function ordersCreateTaxesWithHttpInfo($id, $order_tax_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['ordersCreateTaxes'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalFemsa\Model\UpdateOrderTaxResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DigitalFemsa\Model\UpdateOrderTaxResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\DigitalFemsa\Model\UpdateOrderTaxResponse', []),
            ...
            $returnType = '\DigitalFemsa\Model\UpdateOrderTaxResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DigitalFemsa\Model\UpdateOrderTaxResponse',
    ...
    public function ordersCreateTaxesRequest($id, $order_tax_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['ordersCreateTaxes'][0])
    {
        ...
        if (isset($order_tax_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($order_tax_request));
            } else {
    ...
    public function ordersUpdateTaxesRequest($id, $tax_id, $update_order_tax_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['ordersUpdateTaxes'][0])
    {
        ...
        if (isset($update_order_tax_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($update_order_tax_request));
            } else {
