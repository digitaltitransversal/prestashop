...
class ChargesApi
{
    ...
    public function getChargesWithHttpInfo($accept_language = 'es', $x_child_company_id = null, $limit = 20, $next = null, $previous = null, $search = null, string $contentType = self::contentTypes['getCharges'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalFemsa\Model\GetChargesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DigitalFemsa\Model\GetChargesResponse' !== 'string') {
                            try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DigitalFemsa\Model\GetChargesResponse',
    ...
    public function getChargesRequest($accept_language = 'es', $x_child_company_id = null, $limit = 20, $next = null, $previous = null, $search = null, string $contentType = self::contentTypes['getCharges'][0])
    {
        ...
        if ($limit !== null && $limit > 250) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ChargesApi.getCharges, must be smaller than or equal to 250.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ChargesApi.getCharges, must be bigger than or equal to 1.');
        }
    ...
    {
        list($response) = $this->ordersCreateChargeWithHttpInfo($id, $charge_request, $accept_language, $x_child_company_id, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->ordersCreateChargeRequest($id, $charge_request, $accept_language, $x_child_company_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalFemsa\Model\ChargeOrderResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DigitalFemsa\Model\ChargeOrderResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\DigitalFemsa\Model\ChargeOrderResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\DigitalFemsa\Model\ChargeOrderResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DigitalFemsa\Model\ChargeOrderResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ordersCreateChargeAsync($id, $charge_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['ordersCreateCharge'][0])
    {
        return $this->ordersCreateChargeAsyncWithHttpInfo($id, $charge_request, $accept_language, $x_child_company_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ordersCreateChargeAsyncWithHttpInfo($id, $charge_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['ordersCreateCharge'][0])
    {
        $returnType = '\DigitalFemsa\Model\ChargeOrderResponse';
        $request = $this->ordersCreateChargeRequest($id, $charge_request, $accept_language, $x_child_company_id, $contentType);
    ...
    /**
     * Create request for operation 'ordersCreateCharge'
     *
     * @param  string $id Identifier of the resource (required)
     * @param  \DigitalFemsa\Model\ChargeRequest $charge_request requested field for a charge (required)
     * @param  string $accept_language Use for knowing which language to use (optional, default to 'es')
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ordersCreateChargeRequest($id, $charge_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['ordersCreateCharge'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling ordersCreateCharge'
            );
        }
        ...
        if ($charge_request === null || (is_array($charge_request) && count($charge_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $charge_request when calling ordersCreateCharge'
            );
        }
        ...
        $resourcePath = '/orders/{id}/charges';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $id Identifier of the resource (required)
     * @param  \DigitalFemsa\Model\ChargeUpdateRequest $charge_update_request requested field for update a charge (required)
     * @param  string $accept_language Use for knowing which language to use (optional, default to 'es')
     * @param  string $x_child_company_id In the case of a holding company, the company id of the child company to which will process the request. (optional)
     ...
     * @throws \DigitalFemsa\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \DigitalFemsa\Model\ChargeResponse|\DigitalFemsa\Model\Error|\DigitalFemsa\Model\Error|\DigitalFemsa\Model\Error
     */
     ...
     * @throws \DigitalFemsa\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \DigitalFemsa\Model\ChargeResponse|\DigitalFemsa\Model\Error|\DigitalFemsa\Model\Error|\DigitalFemsa\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateChargeWithHttpInfo($id, $charge_update_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['updateCharge'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\DigitalFemsa\Model\ChargeResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\DigitalFemsa\Model\ChargeResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\DigitalFemsa\Model\ChargeResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\DigitalFemsa\Model\ChargeResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DigitalFemsa\Model\ChargeResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function updateChargeRequest($id, $charge_update_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['updateCharge'][0])
    {
        ...
        if (isset($charge_update_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($charge_update_request));
            } else {
